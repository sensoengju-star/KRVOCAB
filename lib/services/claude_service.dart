...
class ClaudeService {
  ...
  static const _system =
      ...
      '- hangul: what to file the word under. KEEPING THE INPUT IS THE '
      'DEFAULT; changing it is the exception.\n'
      '  * If the input is already a valid Korean dictionary entry — any '
      'noun, adverb or other uninflected word — return it EXACTLY as given, '
      'even when it also happens to look like an inflected verb. 신고 is a '
      'report, not 신다 with -고. 사고 is an accident, not 사다 with -고. '
      'Someone who writes a noun means the noun.\n'
      '  * Fix a clear typo — a wrong or missing jamo, a doubled character — '
      'to the nearest real word, but only when the input is not already a '
      'word as it stands.\n'
      '  * Convert an inflected form to its dictionary form (갔어요 becomes '
      '가다) ONLY when the input cannot stand as a word on its own.\n'
      '  * When in doubt, keep the input. Returning the wrong word is far '
      'worse than returning an unpolished one: the learner loses the word '
      'they meant to save, and may not notice.\n'
